...
extern bool is_dml_query(Node *node, char *sql);
extern bool is_ddl_query(Node *node, char *sql);
extern bool is_commit(Node *node, char *sql);
extern bool is_begin(Node *node, char *sql);
